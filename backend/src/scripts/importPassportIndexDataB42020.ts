...
const MONGO_URI = 'mongodb+srv://1stjarbrofistcom_db_user:YzcUU2CzTDlPdDLF@cluster0.yxwqujt.mongodb.net/?appName=Cluster0';

// 🛑 CẤU HÌNH CHO LẦN CHẠY NÀY
const PERIOD = "2019-11"; // Đổi tên kỳ tùy theo file CSV bác đang định import
      ...
      .on('end', async () => {
        try {
          ...
          for (const row of results) {
            ...
            // ========================================================
            // 🚀 HÀM DỊCH MÃ TỪ SỐ SANG TEXT (Chuẩn hóa trước khi Insert)
            // ========================================================
            const translateStatus = (val: string): string => {
              ...
              if (s === '-1') return '-1';
              return s; // Giữ nguyên nếu data vốn dĩ đã là dạng text chuẩn
            };

            // Lấy các cột còn lại làm destinations VÀ áp dụng hàm dịch mã
