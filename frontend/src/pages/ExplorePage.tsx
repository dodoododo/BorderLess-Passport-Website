...
export function ExplorePage({ theme }: ExplorerPageProps) {
  ...
  // 1. FETCH DATA Ở ĐÂY (Trang cha cầm data)
  ...
  // 2. TẠO BẢNG MÀU TỪ DATA VỪA FETCH (Dùng useMemo để không tính lại khi không cần thiết)
  ...
  return (
    <main className="pt-16 md:pt-16 w-full flex flex-col items-center">      
            ...
            >
              <h1
                ...
                style={{ 
                  ...
                  fontWeight: 500, 
                  fontStyle: 'italic' // Thêm italic vào cho Fraunces nhìn cực nghệ
                }}
              >
                Discover the{' '}
      ...
      {/* 2. KHÔNG DÙNG {selectedPassport && ...} NỮA, HIỂN THỊ LUÔN */}
      <div className="flex flex-col w-full animate-in fade-in slide-in-from-bottom-8 duration-1000 ease-out fill-mode-forwards">
        ...
        <section className="w-full relative">
          ...
          <div className="">
            <WorldMap 
              height="550px" 
              theme={theme} 
              countryColors={mapColors} // Lúc chưa chọn, cái này là {} => Map tự tô xám mặc định
            />
          </div>
        </section>

        {/* PASSPORT EXPLORER: Kiểm tra nếu chưa chọn thì hiện Empty State */}
        <section className="w-full border-t border-neutral-200">
          {!selectedPassport ? (
            // Trạng thái khi chưa chọn hộ chiếu
